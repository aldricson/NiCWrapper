...
#include "task.hpp"  // for Task, Closure, AnimationTask
#include "../screen/screen.hpp"  // for Pixel, Screen::Cursor, Screen, Screen::Cursor::Hidden
...
#include "animation.hpp"  // for TimePoint, Clock, Duration, Params, RequestAnimationFrame
#include "captured_mouse.hpp"  // for CapturedMouse, CapturedMouseInterface
#include "component_base.hpp"  // for ComponentBase
#include "event.hpp"           // for Event
#include "loop.hpp"            // for Loop
#include "receiver.hpp"  // for ReceiverImpl, Sender, MakeReceiver, SenderImpl, Receiver
#include "screen_interactive.hpp"
#include "terminal_input_parser.hpp"  // for TerminalInputParser
#include "../dom/node.hpp"                         // for Node, Render
#include "../dom/requirement.hpp"                  // for Requirement
#include "../screen/terminal.hpp"                  // for Dimensions, Size
