...
void mainMenu::displayMainMenu() 
{
    ...
    options.push_back(" 4 . Show modbus mapping table "); actions.push_back( [this](){this-> m_mappingTableMenu  ->displayTableMenu       ();});
    options.push_back(" 5 . Exit                      "); actions.push_back( [this](){   std::cout << "Exiting..." << std::endl;
