...
#include "elements.hpp"  // for Decorator, Element, focusPosition, focusPositionRelative
#include "node_decorator.hpp"  // for NodeDecorator
#include "requirement.hpp"  // for Requirement, Requirement::NORMAL, Requirement::Selection
