...
#include "component.hpp"          // for Make, Input
#include "component_base.hpp"     // for ComponentBase
#include "component_options.hpp"  // for InputOption
#include "event.hpp"  // for Event, Event::ArrowDown, Event::ArrowLeft, Event::ArrowLeftCtrl, Event::ArrowRight, Event::ArrowRightCtrl, Event::ArrowUp, Event::Backspace, Event::Delete, Event::End, Event::Home, Event::Return
#include "mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Pressed
#include "screen_interactive.hpp"  // for Component
#include "../dom/elements.hpp"  // for operator|, reflect, text, Element, xflex, hbox, Elements, frame, operator|=, vbox, focus, focusCursorBarBlinking, select
#include "../screen/box.hpp"    // for Box
#include "../screen/string.hpp"           // for string_width
...
#include "../util/ref.hpp"                // for StringRef, Ref
