...
#include "animation.hpp"  // for Animator, Params (ptr only)
#include "captured_mouse.hpp"  // for CapturedMouse
#include "component.hpp"       // for Make, Button
#include "component_base.hpp"  // for ComponentBase
#include "component_options.hpp"  // for ButtonOption, AnimatedColorOption, AnimatedColorsOption, EntryState
#include "event.hpp"  // for Event, Event::Return
#include "mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Pressed
#include "screen_interactive.hpp"  // for Component
#include "../dom/elements.hpp"  // for operator|, Decorator, Element, operator|=, bgcolor, color, reflect, text, bold, border, inverted, nothing
#include "../screen/box.hpp"    // for Box
#include "../screen/color.hpp"  // for Color
#include "../util/ref.hpp"      // for Ref, ConstStringRef
