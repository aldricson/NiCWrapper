...
#include "component_options.hpp"  // for SliderOption
...
#include "component.hpp"       // for Make, Slider
#include "component_base.hpp"  // for ComponentBase
#include "event.hpp"  // for Event, Event::ArrowDown, Event::ArrowLeft, Event::ArrowRight, Event::ArrowUp
#include "mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Pressed, Mouse::Released
#include "screen_interactive.hpp"  // for Component
#include "../dom/elements.hpp"  // for operator|, text, Element, xflex, hbox, color, underlined, reflect, Decorator, dim, vcenter, focus, nothing, select, yflex, gaugeDirection
...
#include "../util/ref.hpp"      // for ConstRef, Ref, ConstStringRef
