...
#include "component.hpp"          // for Make, Radiobox
#include "component_base.hpp"     // for ComponentBase
#include "component_options.hpp"  // for RadioboxOption, EntryState
#include "event.hpp"  // for Event, Event::ArrowDown, Event::ArrowUp, Event::End, Event::Home, Event::PageDown, Event::PageUp, Event::Return, Event::Tab, Event::TabReverse
#include "mouse.hpp"  // for Mouse, Mouse::WheelDown, Mouse::WheelUp, Mouse::Left, Mouse::Released
#include "screen_interactive.hpp"  // for Component
#include "../dom/elements.hpp"  // for operator|, reflect, Element, vbox, Elements, focus, nothing, select
#include "../screen/box.hpp"   // for Box
#include "../screen/util.hpp"  // for clamp
#include "../util/ref.hpp"     // for Ref, ConstStringListRef
