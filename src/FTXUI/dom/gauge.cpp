...
// the LICENSE file.
#include "direction.hpp"  // for Direction, Direction::Down, Direction::Left, Direction::Right, Direction::Up
#include <memory>                   // for allocator, make_shared
#include <string>                   // for string

#include "elements.hpp"  // for Element, gauge, gaugeDirection, gaugeDown, gaugeLeft, gaugeRight, gaugeUp
#include "node.hpp"         // for Node
#include "requirement.hpp"  // for Requirement
#include "../screen/box.hpp"       // for Box
#include "../screen/screen.hpp"    // for Screen, Pixel
