...
#include "../dom/direction.hpp"  // for Direction, Direction::Down, Direction::Left, Direction::Right, Direction::Up
...
#include "animation.hpp"       // for Animator, Linear
#include "captured_mouse.hpp"  // for CapturedMouse
#include "component.hpp"  // for Make, Menu, MenuEntry, Toggle
#include "component_base.hpp"     // for ComponentBase
#include "component_options.hpp"  // for MenuOption, MenuEntryOption, UnderlineOption, AnimatedColorOption, AnimatedColorsOption, EntryState
#include "event.hpp"  // for Event, Event::ArrowDown, Event::ArrowLeft, Event::ArrowRight, Event::ArrowUp, Event::End, Event::Home, Event::PageDown, Event::PageUp, Event::Return, Event::Tab, Event::TabReverse
#include "mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Released, Mouse::WheelDown, Mouse::WheelUp, Mouse::None
#include "screen_interactive.hpp"  // for Component
#include "../dom/elements.hpp"  // for operator|, Element, reflect, Decorator, nothing, Elements, bgcolor, color, hbox, separatorHSelector, separatorVSelector, vbox, xflex, yflex, text, bold, focus, inverted, select
#include "../screen/box.hpp"    // for Box
#include "../screen/color.hpp"  // for Color
#include "../screen/util.hpp"   // for clamp
#include "../util/ref.hpp"  // for Ref, ConstStringListRef, ConstStringRef
