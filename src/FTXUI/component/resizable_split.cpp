...
// the LICENSE file.
#include "component_options.hpp"  // for ResizableSplitOption
...
#include "component.hpp"  // for Horizontal, Make, ResizableSplit, ResizableSplitBottom, ResizableSplitLeft, ResizableSplitRight, ResizableSplitTop
#include "component_base.hpp"  // for Component, ComponentBase
#include "event.hpp"           // for Event
#include "mouse.hpp"  // for Mouse, Mouse::Left, Mouse::Pressed, Mouse::Released
#include "../dom/elements.hpp"  // for operator|, reflect, Element, size, EQUAL, xflex, yflex, hbox, vbox, HEIGHT, WIDTH, text
